...
namespace Chapter4
{
    int Chapter4StencilTestingMain()
    {
        ...
        // -------------------------
        Shader shader("Chapter4/2.stencil_testing.vs", "Chapter4/2.stencil_testing.fs");
        Shader shaderSingleColor("Chapter4/2.stencil_testing.vs", "Chapter4/2.stencil_single_color.fs");
