...
namespace Chapter2
{
	...
	int Chapter2MultipleLightsMain()
	{
		...
		// ------------------------------------
		Shader lightingShader("Chapter2/6.multiple_lights.vs", "Chapter2/6.multiple_lights.fs");
		Shader lightCubeShader("Chapter2/2.1.light_cube.vs", "Chapter2/6.light_cube.fs");
