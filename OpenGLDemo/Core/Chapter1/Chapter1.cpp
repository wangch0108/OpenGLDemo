...
int Chapter1Main()
{
    ...
    glViewport(100, 200, SCR_WIDTH - 100, SCR_HEIGHT - 300);
    ...
    // NOTE: the second triangle will not render when draw in wireframe polygons, because the bottom left vertex is edging. it can be fixed by coordinate (-0.999f, -0.999f)
...
inline void framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
    ...
    glViewport(100, 200, width - 100, height - 300);
}